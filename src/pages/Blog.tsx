...
const Blog = () => {
  return (
    <Layout>
      <main className=" min-h-screen bg-gray-900 sm:flex-none md:flex-none lg:flex-none">
        <div className="container m-auto grid grid-cols-1 place-items-center gap-3 md:grid-cols-2 lg:grid-cols-3">
          <div className="max-w-sm pt-10 lg:flex lg:max-w-md">
            <div
